	...
	<div class="row" style="height:45px;">
		...
		<div  class="center" id="div_menu_2">
			<div style="float:left;margin-top:8px;" >
				<div class="div_menu_2" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><a href="?pg=home" class="div_menu_2">Home</a></div>
				<div class="div_menu_2" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><a href="?pg=institucional" class="div_menu_2">Institucional</a></div>
				<div class="div_menu_2" onmouseover="document.getElementById('menu_produto').style.display='none';" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><a href="?pg=servicos" class="div_menu_2">Serviços</a></div>
				<div class="div_menu_2"  onmouseover="document.getElementById('menu_produto').style.display='block';" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';">
					<?php 
						...
						if($total%5>0)
							...
							$colunas=($total/5);
					?>
					<div id="menu_produto" style="display:none;"  onmouseout="document.getElementById('menu_produto').style.display='none';">
							...
							<div style="width:90px; height:126px; float:left; text-align:left; padding-left:7px; font-size:14px; color:#FFF;display:block;">
								...
								?>
											...
											<div style="width:90px; height:126px; float:left; text-align:left; padding-left:7px; font-size:14px; color:#FFF;display:block">
												<br>
											<?php }?>								
											<a href="?pg=produtos&cat=<?php echo $row["codigo"];?>" style="text-decoration: none; color: rgb(255, 255, 255);" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><?php echo $row["nome"];?> &gt;</a><br>
								<?php 		
											$i++;
										}
								?>
				...
				<div class="div_menu_2" onmouseover="document.getElementById('menu_produto').style.display='none';" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><a href="?pg=trabalheconosco" class="div_menu_2">Trabalhe Conosco</a></div>
				<div class="div_menu_2" onmousemove="this.style.color='red';" onmouseout="this.style.color='white';"><a href="?pg=contato" class="div_menu_2">Contatos</a></div>
			</div>
